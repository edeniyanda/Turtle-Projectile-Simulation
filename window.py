...
class MainWindow(QMainWindow, ui):
    ...
    def getValues(self):
        ...
        scale = (self.spinBox_scale.trxt()) if scale != 0 else 1.5
        time = int(self.spinBox_time.text())

        simulator = ProjectileSimulator(initialvelocity, angle_of_projection, g)
